        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            try {
                ...
                if ($result) {
                    ...
                    echo '</svg>';
                    echo '<span class="text-lg font-semibold">Veritabanı bağlantısı başarılı!</span>';
                    echo '</div>';
                    ...
                    foreach ($tables as $table) {
                        ...
                        if ($table_check && $table_check->num_rows > 0) {
                            echo '<span class="text-green-500 mr-2">✓</span>';
                            echo '<span class="text-gray-700">' . $table . ' tablosu mevcut</span>';
                        } else {
                            echo '<span class="text-red-500 mr-2">✗</span>';
                            echo '<span class="text-gray-700">' . $table . ' tablosu bulunamadı!</span>';
                        }
                        echo '</div>';
                    }
                    echo '</div>';
                ...
                echo '</svg>';
                echo '<div>';
                echo '<h3 class="text-lg font-medium text-red-700">Bağlantı hatası!</h3>';
