            ...
            <form id="pageForm" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <label for="pageTitle" class="sr-only">Title</label><input type="text" name="title" id="pageTitle" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">URL</label>
                        <label for="pageSlug" class="sr-only">Slug</label><input type="text" name="slug" id="pageSlug" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                    </div>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">İçerik</label>
                    <label for="pageContent" class="sr-only">Content</label><textarea name="content" id="pageContent" rows="10"
