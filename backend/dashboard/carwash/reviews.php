...
<head>
    ...
    <title>Değerlendirmeler - CarWash Panel</title>
...
<body class="bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-gray-500 text-sm mb-1">Toplam Değerlendirme</div>
                <div class="text-2xl font-bold" id="totalReviews">-</div>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-gray-500 text-sm mb-1">Son 30 Gün</div>
                <div class="text-2xl font-bold" id="recentReviews">-</div>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-gray-500 text-sm mb-1">Yanıt Oranı</div>
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="p-6 border-b">
                <h2 class="text-lg font-bold">Değerlendirmeler</h2>
            </div>
