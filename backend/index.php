      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div class="animate-fade-in-up">
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            <a href="../backend/auth/Customer_Registration.php" class="bg-white text-blue-600 px-8 py-4 rounded-lg font-bold hover:bg-gray-100 transition-all text-center animate-pulse-slow">
              <i class="fas fa-user-plus ml-2"></i>
              Müşteri Olarak Kayıt Ol
            </a>
            <a href="../backend/auth/Car_Wash_Registration.php" class="border-2 border-white text-white px-8 py-4 rounded-lg font-bold hover:bg-white hover:text-blue-600 transition-all text-center">
        ...
        <div class="animate-slide-in">
          <div class="bg-white rounded-2xl p-8 shadow-2xl">
            <h3 class="text-2xl font-bold text-gray-800 mb-6 text-center">Neden CarWash?</h3>
            <div class="space-y-4">
              <div class="flex items-center">
                <i class="fas fa-clock text-blue-600 text-2xl mr-4"></i>
                <div>
                  <h4 class="font-bold text-gray-800">Yüksek Hız</h4>
                  <p class="text-gray-600">2 Dakikadan Az Sürede Rezervasyon</p>
                </div>
              </div>
              <div class="flex items-center">
                <i class="fas fa-shield-alt text-blue-600 text-2xl mr-4"></i>
                <div>
                  <h4 class="font-bold text-gray-800">Tam Güvenlik</h4>
                  <p class="text-gray-600">Güvenli ve Garantili Ödeme</p>
                </div>
              </div>
              <div class="flex items-center">
                <i class="fas fa-star text-blue-600 text-2xl mr-4"></i>
                <div>
                  <h4 class="font-bold text-gray-800">Üstün Kalite</h4>
                  <p class="text-gray-600">Şehrin En İyi Uzmanları</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
        <div class="animate-fade-in-up">
          ...
          <div class="text-gray-600">Memnun Müşteri</div>
        </div>
        <div class="animate-fade-in-up" style="animation-delay: 0.2s">
          <div class="text-4xl font-bold text-blue-600 mb-2">500+</div>
          <div class="text-gray-600">Aktif Hizmet Sağlayıcı</div>
        </div>
        <div class="animate-fade-in-up" style="animation-delay: 0.4s">
          <div class="text-4xl font-bold text-blue-600 mb-2">10000+</div>
          <div class="text-gray-600">Tamamlanan Hizmet</div>
        </div>
  ...
  <section id="services" class="py-20 bg-gray-50">
    <div class="container mx-auto px-4">
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-600">En İyi Kalitede Çeşitli Araç Yıkama Hizmetleri</p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div class="bg-white rounded-2xl p-8 card-hover shadow-lg">
          ...
          <h3 class="text-2xl font-bold text-gray-800 mb-4">Dış Yıkama</h3>
          <p class="text-gray-600 mb-6">Modern Ekipman ve En İyi Temizlik Malzemeleri ile Tam Gövde Yıkama</p>
        ...
        <div class="bg-white rounded-2xl p-8 card-hover shadow-lg">
          ...
          <h3 class="text-2xl font-bold text-gray-800 mb-4">İç Temizlik</h3>
          <p class="text-gray-600 mb-6">Otomobilin İç Mekanı, Koltuklar, Torpido ve Konsolunun Tam Temizliği</p>
        ...
        <div class="bg-white rounded-2xl p-8 card-hover shadow-lg">
          ...
          <h3 class="text-2xl font-bold text-gray-800 mb-4">Tam Detaylandırma</h3>
          <p class="text-gray-600 mb-6">Dış Yıkama, İç Temizlik ve Gövde Cilası Dahil Tam Hizmet</p>
